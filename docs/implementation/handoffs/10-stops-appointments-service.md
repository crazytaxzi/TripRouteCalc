...
- Replaced two equivalent null checks with optional chaining to satisfy the repository lint policy without changing stop-mutation or leg-validation behavior.
- Removed every temporary reconstruction, migration-diagnostic, and lint-diagnostic workflow after use.
