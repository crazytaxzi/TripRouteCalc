...
- Stage 17 adds a Fastify 5 REST boundary with strict Zod validation, authenticated tenant context, typed encrypted public identifiers, immutable revision writes, persistent idempotency, optimistic conflict handling, structured legal and provider errors, rate limiting, deterministic OpenAPI 3.1 documentation, and PostgreSQL-backed acceptance coverage.
